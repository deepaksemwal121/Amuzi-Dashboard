...
const Header = () => {
  return (
    <div className="flex w-full  space-x-[56px] mt-[48px] font-medium px-[24px] text-[#141414]">
      ...
      <div className="w-3/12">Tournament</div>
      <div className="w-1/12">Sports </div>
      <div className="w-2/12">Start Date</div>
      <div className="w-2/12">End Date</div>
      <div className="w-1/12">Teams</div>
      <div className="w-1/12">Matchs</div>
      <div className="w-1/12">Status</div>
      <div className="w-auto">Edit</div>
    </div>
  );
};
